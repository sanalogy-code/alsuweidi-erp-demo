...
- **Navigation restructure** (day 10, Batch 22, from the founder's own usability review) — module sidebars reorganized from flat register lists into intent groups with sub-view tabs (Finance 12→5, HR workspace 16→6, Office 7→3), plus verb-first action cards on the Finance overview that open the right form in one click
