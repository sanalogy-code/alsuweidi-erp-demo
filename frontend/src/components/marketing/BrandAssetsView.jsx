...
import { Palette, Download, FileImage, FileText, LayoutTemplate, Stamp, Camera } from 'lucide-react'
import { BRAND_ASSETS, BRAND_ASSET_CATEGORIES } from '../../data/marketingData'
...
// Branding materials library — the one Marketing view visible to EVERYONE.
// Downloads are mocked until Phase 2 file storage.
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="p-4 border-b border-gray-200">
        <h2 className="text-sm font-semibold text-gray-800 flex items-center gap-2">
          <Palette size={15} className="text-brand" /> Branding materials
        </h2>
        <p className="text-xs text-gray-500 mb-3">
          Approved logos, templates, and guidelines — always use these, never a re-saved copy. Files are placeholders until Phase 2 storage.
        </p>
