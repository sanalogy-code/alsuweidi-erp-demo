...
const MODULE_SCREENS = [
  ...
  { label: 'Projects — My Work', to: '/projects' }, { label: 'Projects — PMO', to: '/projects' }, { label: 'Projects — Active projects', to: '/projects' }, { label: 'Projects — Analytics', to: '/projects' }, { label: 'Projects — Resource planner', to: '/projects' },
